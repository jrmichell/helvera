export default function TitleCard() {
  return (
    <div className="flex justify-between items-start text-white font-bold rounded-xl border shadow-lg bg-gradient-to-r from-primary to-offset text-sm w-full my-1 p-4 mx-auto">

export default function TitleCard() {
  return (
    <div className="flex justify-center text-start text-white font-bold rounded-xl border shadow-lg bg-gradient-to-r from-primary to-offset text-sm w-full my-1 py-4 px-2 p-8 mx-auto">
